...
<!-- sub-content // S -->
	<div id="sub_content" class="center_info">
		...
		<aside>
			...
			<a href="" title="관리페이지 바로가기">관리페이지</a>
		</aside>	
		<section class="info_container">
			...
			<div class="info_contents">
				<section class="center_image">
					<h1>보호소 사진</h1>
					<ul>
						<li><img src="../img/main/shaterlisttast.jpg" alt="보호소사진1" /><button type="button">확대보기</button></li>
				...
				<section class="center_inform">
					...
					<table>
						...
						<tr>
							...
							<td colspan="3">
							경기도 남양주시에 위치하여 2011년부터 여러 봉사자들과 함께 동물들을 보호해 오고 있습니다.
							강아지,고양이 합쳐서 100여마리 규모의 보호소 입니다.</td>
						</tr>
						<tr>
							<th scope="row"><h2>대표사이트<h2></th>
							<td colspan="3"><a class="url" href="http://cafe.naver.com/masuck_dg" target="_blank" title="사이트 새창열림">http://cafe.naver.com/masuck_dg</a></td>
						</tr>
					</table>
			...
			<div class="list_area ">
				<h2>품고있는 동물들</h2>
				<span class="animal_num">등록된 동물 <span>366 마리</span></span>	
